...
public class SortableDataTables {
    ...
    public void categoryTables() {
        ...
        List<WebElement> elements = browser.findElements(By.cssSelector(".tablesorted thead tr th"));
        ...
        List<WebElement> johnSmith = browser.findElements(By.xpath("//tbody/tr[1]/td"));
        ...
        List<WebElement> conwayTim = browser.findElements(By.xpath("//tbody/tr[4]/td"));
        for (WebElement element : conwayTim) {
            assertEquals(conwayTim.get(0).getText(), "Conway");
            assertEquals(conwayTim.get(1).getText(), "Tim");
            assertEquals(conwayTim.get(2).getText(), "tconway@earthlink.net");
            assertEquals(conwayTim.get(3).getText(), "$50.00");
            assertEquals(conwayTim.get(4).getText(), "http://www.timconway.com");
            assertEquals(conwayTim.get(5).getText(), "edit delete");
        }
